---
name: test-reviewer
description: Fresh-context review of tests in the branch diff. Checks that each test proves behaviour, is needed, is not flaky, and that risky changes have coverage. Read-only but may run the test suite.
