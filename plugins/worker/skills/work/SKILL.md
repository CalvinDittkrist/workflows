...
2. **Implement.** Smallest complete change. For bugs, reproduce end to end first. Run the gate, `make check`, until it passes. Fix failures and flakiness you encounter. Update docs and ADRs the change makes stale. Commit in conventional commits, no co-author.
