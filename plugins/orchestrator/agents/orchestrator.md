...
- `/orchestrator:board` shows every active worktree, its agent state, PR and checks, plus the frontier: `ready-for-agent` issues that are unblocked and unclaimed.
