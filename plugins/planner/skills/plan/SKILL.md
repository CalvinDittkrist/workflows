...
- **Finished spec.** `/planner:accept [spec]` lets a read-only checker judge the spec against the code.
  - It turns the gaps into tickets, accepted deviations or nothing, and closes the spec when nothing is left open.
