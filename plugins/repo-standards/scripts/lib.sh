...
# The names a baseline file of the standard may have, the standard's name first. facts.sh, check.sh and
# scaffold.sh accept exactly these, so the audit, the check and the scaffold agree on what exists.
