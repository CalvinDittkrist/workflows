...
- Dated audit or analysis reports, and planning material: feature specs, PRDs, user stories, personas, research notes, roadmaps.
  - Plans live in issues. If a plan still describes open work, add an `issue` finding that carries it.
