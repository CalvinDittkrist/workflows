...
| `WF_HANDOFF_TOKENS` | `120000` | context size at which a worker hands the next stage to a fresh context; keep it under the 200 000 auto-compact window a claim sets |
