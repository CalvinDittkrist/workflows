...
| `WF_HANDOFF_TOKENS` | `120000` | context size at which a worker hands the next stage to a fresh context; keep it under the compact trigger of 160 000 a claim pins ([ADR 0031](docs/adr/0031-the-workflow-pins-the-size-at-which-a-worker-session-compacts.md)) |
