...
16. Removing the routing label or closing the issue cancels a run. Ending without a pull request, or letting go, pushes the worktree; letting go removes it ([ADR 0026](adr/0026-the-factory-never-deletes-work-on-its-own.md)).
