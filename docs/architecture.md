...
16. Removing the routing label or closing the issue cancels a run. A run ending without a pull request, or let go, pushes its worktree first ([ADR 0026](adr/0026-the-factory-never-deletes-work-on-its-own.md)).
