# 0022. A claim is the creation of the branch through the GitHub API
...
The claim outlives the claimer. A factory that dies after the claim leaves a branch that refuses every later claimer, which is what the release signal and the cleanup rules of [ADR 0024](0024-the-factory-never-deletes-work-on-its-own.md) exist for.
