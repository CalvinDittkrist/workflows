...
- The mattpocock skills (grilling, to-spec, to-tickets, triage, wayfinder, prototype) cover that job.
- They load into every session, need a per-repository `issue-tracker.md` and carry prose the model does not need.
