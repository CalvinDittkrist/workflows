...
## Context
- Every change, documentation included, paid for the full gate and five reviewers before its pull request.
...
- The gate before the pull request is the class's gate command.
