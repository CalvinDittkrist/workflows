...
- A repository not rewritten yet sets `WF_WRITING_LENIENT=1` for its standard target and gets warnings instead. `/repo-standards:apply` checks the same way and files the rewrite as an issue.
