...
1. **The user and its directories.**
   ...
   out=$(mktemp)
   curl -fsSLo "$out" https://cli.github.com/packages/githubcli-archive-keyring.gpg
   echo "6084d5d7bd8e288441e0e94fc6275570895da18e6751f70f057485dc2d1a811b  $out" | sha256sum --check &&
     install -D -m 0644 "$out" "$key" &&
