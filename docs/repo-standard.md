...
- Dependabot alerts and security updates; read-only default token for Actions. Grouped version updates are a file, `.github/dependabot.yml`, and arrive with the cleanup pull request.
